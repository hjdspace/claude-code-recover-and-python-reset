...
def _get_background_usage_note(*, disable_background_tasks: bool = False) -> Optional[str]:
...
def get_prompt(
    *,
    ...
    background_note = _get_background_usage_note(disable_background_tasks=disable_background_tasks)
    sleep_guidance = _get_sleep_guidance(disable_background_tasks=disable_background_tasks)
